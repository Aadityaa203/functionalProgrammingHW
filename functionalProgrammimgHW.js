...
// Only change code above this lineIn the code editor, the prepareTea and getTea functions are already defined for you. Call the getTea function to get 40 cups of tea for the team, and store them in the tea4TeamFCC variable.
...
function remove(arr, bookName) {
  let newArr = [...arr]; // copy the booklist array to new array
  if (newArr.indexOf(bookName) >= 0) {
    // check whether the bookname parameter is in the new array
    newArr.splice(newArr.indexOf(bookName), 1); // remove the given paramenter from the new array
    return newArr; // return the new array
  }
}
